...
class BusEnv(gym.Env):
    ...
    def __init__(self,env):
        ...
        self.rewardfiles.write('reward,reward_accumulate\n')
        ...
        #========DEFINE FILE TO WRITE ON FROM THE OLD ENVIRONMENT
        if env == "MAB" or env == "UCB" or env == "RGreedy" or env == "FDQO" or \
            ...
            # self.rewardfiles = open(self.folder + "reward.csv", "w")
            # self.drop_files = open(self.folder + "drop_task.csv", "w")
            # self.delay_files = open(self.folder+ "delay.csv", "w")
            # self.server_allocation = open(self.folder+ "server_allocation.csv", "w")
            # self.delay_allocation = open(self.folder+ "delay_allocation.csv", "w")
            #self.drop_allocation = open(RESULT_DIR + MyGlobals.folder_name + "drop_allocation.csv","w")
            # self.extra_allocation = open(self.folder+ "extra_allocation.csv", "w")
            # self.sum_extra_allocation = open(self.folder + "sum_extra_allocation.csv", "w")
